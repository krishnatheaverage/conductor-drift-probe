...
confidence intervals overlap at every layer. Beyond the specific null, the transferable
...
above, in the feature space the method uses, and (ii) a static-projector baseline shown to
re-entangle. On the present evidence neither is established, which suggests the conditional
machinery may, for the behaviors and models studied, be addressing a confound rather than a
real non-stationarity.
