...
subspace, the noise-corrected chordal drift is $0.144$ against the analytic value $0.149$,
a $3.4\%$ relative error, and the decision rule fires positive. With a static (zero-rotation)
